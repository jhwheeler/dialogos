...
export type CreateOneSessionDataSourceInput = z.infer<typeof CreateOneSessionDataSourceInputSchema>;
...
export type CreateOneSessionDataSourceOutput = z.infer<
  typeof CreateOneSessionDataSourceOutputSchema
>;
