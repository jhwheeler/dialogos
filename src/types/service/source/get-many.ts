...
export type GetManySourceServiceInput = z.infer<typeof GetManySourceServiceInputSchema>;

export const GetManySourceServiceOutputSchema = z.array(
  z.object({
    id: z.string().uuid(),
    topicId: z.string().uuid(),
...
export type GetManySourceServiceOutput = z.infer<typeof GetManySourceServiceOutputSchema>;
